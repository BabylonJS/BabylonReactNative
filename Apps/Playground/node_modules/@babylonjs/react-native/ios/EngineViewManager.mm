...
- (void)setView {
    ...
    // TODO: Move most of this logic to the interop layer
    if (width != 0 && height != 0) {
        const CGFloat scale = UIScreen.mainScreen.scale;
        [BabylonNativeInterop setView:bridge jsRunLoop:runLoop mktView:self width:static_cast<int>(width * scale) height:static_cast<int>(height * scale)];
    }
}
