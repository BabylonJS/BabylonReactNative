...
The project must be configured to compile Swift. Typically this means having at least one `.swift` file in the project plus the associated `<project name>-Bridging-Header.h` file.
