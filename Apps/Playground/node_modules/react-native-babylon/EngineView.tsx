...
export const EngineView: FunctionComponent<EngineViewProps> = (props: EngineViewProps) => {
    ...
    useEffect(() => {
        if (props.displayFrameRate ?? __DEV__) {
            const engine = props.camera?.getScene().getEngine();
            if (engine) {
    ...
    if (!failedInitialization) {
        ...
        return (
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                ...
                { !global['nativeCallSyncHook'] && <Text style={{fontSize: 12}}>React Native remote debugging does not work with Babylon Native.</Text> }
            </View>
        );
    }
}