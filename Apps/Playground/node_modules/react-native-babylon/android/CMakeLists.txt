...
set(NAPI_JAVASCRIPT_ENGINE "JavaScriptInterface" CACHE STRING "The JavaScript engine to power N-API")
...
target_link_libraries(javascript_engine INTERFACE jsi)
#target_link_to_dependencies(javascript_engine INTERFACE jsi)
