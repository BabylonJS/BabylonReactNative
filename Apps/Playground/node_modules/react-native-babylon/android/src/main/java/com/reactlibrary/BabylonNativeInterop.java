...
final class BabylonNativeInterop {
    ...
    private static native long create(long jsContextHandle, long jsContextRef, Surface surface);
        ...
        reactContext.runOnJSQueueThread(() -> {
            ...
            if (instanceRef == null)
            {
                ...
                if (jsContextHandle == 0) {
                    ...
                    instanceRef = BabylonNativeInterop.create(jsContextHandle, jsContextRef, surface);
