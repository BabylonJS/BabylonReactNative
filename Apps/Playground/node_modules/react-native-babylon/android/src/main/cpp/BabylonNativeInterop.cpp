...
extern "C" JNIEXPORT jlong JNICALL Java_com_reactlibrary_BabylonNativeInterop_create(JNIEnv* env, jclass obj, jlong jsContextHandle, jobject surface)
{
    ANativeWindow* windowPtr = ANativeWindow_fromSurface(env, surface);
    auto native = new Babylon::Native(*reinterpret_cast<facebook::jsi::Runtime*>(jsContextHandle), windowPtr);
