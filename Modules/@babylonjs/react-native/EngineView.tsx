...
export const EngineView: FunctionComponent<EngineViewProps> = (props: EngineViewProps) => {
    ...
    const topMost = props.topMost ?? false;
    ...
    if (initialized !== false) {
        return (
            <View style={[{ flex: 1 }, props.style, { overflow: "hidden" }]}>
                { initialized && <NativeEngineView ref={engineViewRef} style={{ flex: 1 }} onSnapshotDataReturned={snapshotDataReturnedHandler} isTransparent={isTransparent} antiAliasing={antiAliasing} topMost={topMost}/> }
